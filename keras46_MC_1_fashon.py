...
hist = model.fit(x_train, y_train, epochs=10, verbose=1, batch_size=100, callbacks=[early_stopping, model_checkpoint],validation_split=0.2)
...
# loss, acc :  0.28314459323883057 0.9056000113487244