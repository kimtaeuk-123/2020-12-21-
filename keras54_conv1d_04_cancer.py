...
model = Sequential()
model.add(Conv1D(filters=10, kernel_size=2, input_shape=(30,1), activation='relu')) # relu 0에서 무한대 , liner -무한대 에서 무한대, 우리가 원하는건 0에서 1 -> sigmoid 사용  
...
# loss =  [0.16781020164489746, 0.9349736571311951]-Conv1D